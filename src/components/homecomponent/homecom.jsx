...
const Homecom = (props) => {
  ...
  return (
    <div className="w-full h-[80vh] bg-no-repeat bg-cover opacity-[.9]" style={{ backgroundImage: `url(${background})` }}>
      <input className="float-right mt-16 lg:mr-28 md:mr-16 lg:w-72 md:w-72 w-[90%] lg:mx-0 md:mx-0 mx-5 h-[60px] rounded-[30px] pl-10" type="text" placeholder="Search" />
      <div className="flex flex-col h-[65vh] lg:w-[50%] md:w-[70%] w-full justify-center lg:pl-36 md:pl-20 md:pb-56 lg:pt-32 pb-[150px]">
        <div className="text-white lg:text-6xl md:text-5xl text-4xl lg:px-0 md:px-0 px-10 font-bold py-2 leading-[70px]">{title}</div>
